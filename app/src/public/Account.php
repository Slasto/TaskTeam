...
<body>
    <script type="text/javascript">
        ...
        function validateEmail() {
            ...
            OldEmail = "<?echo $userProfile["Email"]?>"
        ...
        function handleSubmit(What) {
            ...
            fetch("/api/User/ModifyProfile.php?change=".concat(What), {
                method: "POST",
                headers: {
    ...
    <!-- Sidebar -->
    <object data="/view/SideBar.php?Title=Account" width="100%" height="100%"></object>
        ...
        <div class="mx-auto max-w-7xl py-8 sm:px-6 lg:px-8">
            ...
            <div class="mt-6 border-t border-gray-100">
                <dl class="divide-y divide-gray-100">
                    <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                        ...
                        <dd class="mt-3 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"><? echo $_SESSION["username"] ?></dd>
                    </div>
                </dl>
            </div>
            ...
            <form class="mt-6 border-t divide-y divide-gray-100" action="javascript:handleSubmit('Email')" method="POST" onsubmit="return validateEmail()">
                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                    ...
                    <input id="email" name="email" type="email" autocomplete="email" value="<? echo $userProfile["Email"] ?>" required class="block flex-auto rounded-md border-0 py-1.5 text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                </div>
            ...
            <div class="px-4 pt-2 sm:gap-4 sm:px-0 border-t divide-gray-100">
                <button type="submit" class="flex-auto justify-center rounded-md bg-red-800 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-red-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Elimina account</button>
            </div>
        </div>
    </main>
</body>