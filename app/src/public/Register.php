...
<script>
    ...
    function validateForm() {
        ...
        // Verifica che l'Username non contenca caratteri speciali
        ...
        re = /^[\w\s!@#$%^&*?.]{12,255}$/
        if(!re.test(password)){
            alert("La lunghezza della password deve essere tra 12 e 255 caratteri e senza caratteri accentati");
            return false;
        }
