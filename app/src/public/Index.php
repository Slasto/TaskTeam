    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" action="/" method="POST">
                <div>
                    <label for="username" class="block text-sm font-medium leading-6 text-gray-900 flex items-center justify-between">Username</label>
                    <div class="mt-2">
                ...
                <div>
                    <label for="password" class="block text-sm font-medium leading-6 text-gray-900 flex items-center justify-between">Password</label>
                    <div class="mt-2">
