...
--
-- Host: db
-- Creato il: Gen 31, 2024 alle 23:23
...
(30, 'Consulenza fiscale', 'Consulenza su questioni fiscali per minimizzare l\'imposta sul reddito dell\'azienda', 'In corso', '2024-02-12', 'Pino', '2024-01-21', 38),
...
(33, 'Organizzazione cena aziendale', 'None', 'Da fare', '2024-02-26', NULL, NULL, 38),
...
--
DELIMITER $$
CREATE TRIGGER `DeleteTeamList` BEFORE DELETE ON `Team` FOR EACH ROW BEGIN
...
CREATE TABLE `User` (
  ...
  `Salt` varchar(32) CHARACTER SET ascii COLLATE ascii_general_ci DEFAULT NULL,
  `LastR` int(10) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `User` (`ID`, `Username`, `Email`, `HashPW`, `Salt`, `LastR`) VALUES
(23, 'Pino', 'Vito@email.com', '$2y$10$wZ5trEzJu3vrFJMa2UW.tOrytUyCyOQgi1x5WRmNsF7SMVAHgGB2.', NULL, NULL),
(24, 'Giacomo', 'Aldo@gmail.com', '$2y$10$42FqSJJXoiH5LAUJ4gnPoeQXr1D3UYX7874fnslvdo6OND5/NPQx6', NULL, NULL),
(26, 'Ago', 'valle@ago.com', '$2y$10$t9a9b9OWxz4BdFzytz.6Heg8Kl6JjEnWHFHrOedmE7L8Wlc3ZGzRq', NULL, NULL);
